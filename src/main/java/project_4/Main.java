...
class TodoAPIWrapper {
    ...
    public Todo getTodoByPrority(int priority, TodoCollection todos){
        System.out.println("listing todos with priority " + priority);
        for (Todo todo: todos) {
...
public class Main {
    public static void main(String[] args) {
        TodoAPIWrapper todoAPI = new TodoAPIWrapper("http://todo.eastus.cloudapp.azure.com/todo-android", "kevin", "kevin");

        todoAPI.removeTodo(0);
        todoAPI.removeTodo(1);
        ...
        todoAPI.createTodo("Final", "take final", 5);
        todoAPI.createTodo("Eat", "Eat dinner", 4);
       ...
       // displaying all Todos
        ...
        // listing Todos by a given priority
        todos = todoAPI.getTodos();
        todoAPI.getTodoByPrority(4, todos);

        // removing all Todos besides id 0
        System.out.println("removing todos.");
        todoAPI.removeTodo(1);
        todoAPI.removeTodo(2);
        todoAPI.removeTodo(3);

        // listing all remaining Todos
        System.out.println("Getting todos");
        todos = todoAPI.getTodos();
        for (Todo todo: todos) {
            System.out.println(todo);
